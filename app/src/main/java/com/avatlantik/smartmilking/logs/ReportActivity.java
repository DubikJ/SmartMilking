package com.avatlantik.smartmilking.logs;
...
{
    private static final String EXTRA_THROWABLE  = "extraLogThrowable";
    private static final String EXTRA_SCREENSHOT = "extraLogScreenshot";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
		...
		*/
        ...
        target.putExtra(Intent.EXTRA_SUBJECT, getResources().getString(R.string.log_error_name));
